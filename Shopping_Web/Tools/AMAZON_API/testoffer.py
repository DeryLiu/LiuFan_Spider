...
#     f_asins = open('asin_18.csv','r')
#     asins = f_asins.readlines()
#     pool = Pool(processes = 3)
#     pool.map(get_info,asins)
#     pool.close()
#     pool.join() 
#     ff.close()
#    
...
#     print 'get_product_price is OK------------------------------------'
    ...
    s = amazon_aws.get_product_info('B00EL6IKW4','US')
    
    print s
# #    print 'get_product_info is OK-------------------------------------'
#     ff = open('testcategory.csv','w')
#     ff.write(str(amazon_aws.get_category_tree('US')))
#     ff.close()
