...
(function (factory) {
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    <div class="file-preview-off_shelf text-center text-success"></div>\n' +
    ...
    tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {off_shelf}>{icon} {label}</button>';
    //noinspection HtmlUnknownAttribute
    tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {off_shelf}>{icon} {label}</a>';
    //noinspection HtmlUnknownAttribute
    tBtnBrowse = '<div tabindex="500" class="{css}" {off_shelf}>{icon} {label}</div>';
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            self.$previewStatus = getElement(options, 'elPreviewStatus', self.$container.find('.file-preview-off_shelf'));
        ...
        _renderButton: function (type) {
            ...
            return tmplt.replace('{type}', btnType).replace('{css}', css).replace('{title}', title)
                .replace('{off_shelf}', status).replace('{icon}', icon).replace('{label}', label);
        },
